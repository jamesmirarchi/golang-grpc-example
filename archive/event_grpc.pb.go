...
const (
	EventService_Insert_FullMethodName   = "/event.v1.EventService/Insert"
	EventService_Update_FullMethodName   = "/event.v1.EventService/Update"
	EventService_Remove_FullMethodName   = "/event.v1.EventService/Remove"
	EventService_Retrieve_FullMethodName = "/event.v1.EventService/Retrieve"
)
...
func (c *eventServiceClient) Insert(ctx context.Context, in *InsertRequest, opts ...grpc.CallOption) (*InsertResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_Insert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) Retrieve(ctx context.Context, in *RetrieveRequest, opts ...grpc.CallOption) (*RetrieveResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_Retrieve_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EventService_Insert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_Insert_FullMethodName,
	}
...
func _EventService_Retrieve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_Retrieve_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
